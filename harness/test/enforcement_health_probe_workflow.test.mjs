...
test("promotion verifier job is pull_request only and does not run the probe", () => {
  const promotion = job(loadWorkflow(), "enforcement-health-promotion");
  assert.equal(promotion.if, "github.event_name == 'pull_request'");
