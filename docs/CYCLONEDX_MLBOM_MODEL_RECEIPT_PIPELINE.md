...
On the prepared Assay v3.7.0 Trust Basis surface, supported CycloneDX ML-BOM
...
Harness gate/report layer. With the prepared Assay v3.7.0 surface, the same generic
